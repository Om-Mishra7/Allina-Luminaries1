...
export const Footer = () => {
  return (
    <footer className="bg-black text-[#DDB9A2] py-8 sm:py-12 md:py-16">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1 flex flex-col items-center sm:items-start">
            <Link to="/" className="block mb-4 sm:mb-6">
              <div className="w-[100px] h-[85px] sm:w-[106px] sm:h-[90px] md:w-[120px] md:h-[102px]">
                <svg 
                  width="100%" 
                  height="100%" 
                  viewBox="0 0 137 118" 
            ...
            <p className="text-[#DDB9A2] text-sm leading-relaxed text-center sm:text-left max-w-[250px]">
              Lighting the way to a brighter, more sustainable future through innovative infrastructure solutions.
            </p>
          </div>

          {/* Quick Links */}
          <div className="text-center sm:text-left">
            <h3 className="text-white text-lg sm:text-xl font-semibold mb-4 sm:mb-6 tracking-wide">QUICK LINKS</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link to="/" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/projects" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Projects
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          {/* Other Links */}
          <div className="text-center sm:text-left">
            <h3 className="text-white text-lg sm:text-xl font-semibold mb-4 sm:mb-6 tracking-wide">RESOURCES</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link to="/blogs" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Blogs
                </Link>
              </li>
              <li>
                <Link to="/articles" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Articles
                </Link>
              </li>
              <li>
                <Link to="/journals" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Journals
                </Link>
              </li>
              <li>
                <Link to="/case-studies" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Case Studies
                </Link>
              </li>
              <li>
                <Link to="/downloads" className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block py-1">
                  Downloads
                </Link>
              </li>
            </ul>
          ...
          {/* Contact Info */}
          <div className="text-center sm:text-left">
            <h3 className="text-white text-lg sm:text-xl font-semibold mb-4 sm:mb-6 tracking-wide">CONTACT</h3>
            <div className="space-y-3 sm:space-y-4">
              <div>
                <p className="text-[#DDB9A2] text-sm sm:text-base leading-relaxed">
              ...
              <div>
                <a 
                  href="mailto:info@allina.co.in" 
                  className="text-[#DDB9A2] hover:text-white transition-colors duration-300 text-sm sm:text-base block"
                >
                  info@allina.co.in
                </a>
              </div>
              ...
              <div className="flex justify-center sm:justify-start gap-4 mt-6">
                <a href="#" className="text-[#DDB9A2] hover:text-white transition-colors duration-300">
        ...
        {/* Copyright */}
        <div className="mt-10 sm:mt-12 md:mt-16 pt-6 sm:pt-8 border-t border-[#DDB9A2]/20">
          <div className="text-center lg:flex lg:justify-between lg:items-center">
            <p className="text-[#DDB9A2] text-xs sm:text-sm mb-4 lg:mb-0">
              ©2025 Allina Luminaries Pvt. Ltd. All rights reserved.
            </p>
            <div className="flex justify-center lg:justify-end gap-6 text-xs sm:text-sm">
              <Link to="/privacy" className="text-[#DDB9A2] hover:text-white transition-colors duration-300">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-[#DDB9A2] hover:text-white transition-colors duration-300">
                Terms of Service
              </Link>
            </div>
          </div>
