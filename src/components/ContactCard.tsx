        ...
        <div className="bg-[#06153A] rounded-[20px] sm:rounded-[30px] md:rounded-[40px] p-6 sm:p-10 md:p-16 relative">
          ...
          <div className="mb-12 sm:mb-16 md:mb-24">
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-8">
              <div className="w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-[#E7DED7]"></div>
          ...
          {/* Logo Section */}
          <div className="absolute hidden md:block w-[240px] h-[225px] lg:w-[320.57px] lg:h-[300px] top-1/2 left-5 lg:top-[398px] lg:left-[113.71px] -translate-y-1/2 lg:translate-y-0">
            <svg 
              width="100%" 
              height="100%" 
              viewBox="0 0 137 118" 
          ...
          <div className="w-full md:w-[528px] md:ml-auto">
            ...
            <div className="flex mb-8 sm:mb-12 md:mb-16 border-2 border-[#E7DED7] rounded-md overflow-hidden">
              <button className="flex-1 bg-[#06153A] text-white py-3 sm:py-4 px-4 sm:px-8 text-base sm:text-lg">
                Register with Us
              </button>
              <button className="flex-1 bg-[#E7DED7] text-[#06153A] py-3 sm:py-4 px-4 sm:px-8 text-base sm:text-lg">
                LOREM
              </button>
            </div>
